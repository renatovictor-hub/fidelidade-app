...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (!Number.isFinite(saldoAnterior) || saldoAnterior < custo) {
            return res.status(400).json({ error: "Puntos insuficientes", saldo: saldoAnterior, necesarios: custo });
        }
        ...
        // Mesmo padrão já usado e comprovado em /api/pontos:
        // saldo e histórico são gravados juntos em uma única atualização atômica.
